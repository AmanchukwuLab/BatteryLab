...
static const _SartoriusCtrl_Request_type_support_symbol_names_t _SartoriusCtrl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, SartoriusCtrl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, SartoriusCtrl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, SartoriusCtrl_Request)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::SartoriusCtrl_Request_message_type_support_handle;
}
...
static const _SartoriusCtrl_Response_type_support_symbol_names_t _SartoriusCtrl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, SartoriusCtrl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, SartoriusCtrl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, SartoriusCtrl_Response)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::SartoriusCtrl_Response_message_type_support_handle;
}
...
static const _SartoriusCtrl_Event_type_support_symbol_names_t _SartoriusCtrl_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, SartoriusCtrl_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, SartoriusCtrl_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, SartoriusCtrl_Event)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::SartoriusCtrl_Event_message_type_support_handle;
}
...
static const _SartoriusCtrl_type_support_symbol_names_t _SartoriusCtrl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, SartoriusCtrl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, SartoriusCtrl)),
  }
};
...
static const rosidl_service_type_support_t SartoriusCtrl_service_type_support_handle = {
  ...
  &SartoriusCtrl_Request_message_type_support_handle,
  &SartoriusCtrl_Response_message_type_support_handle,
  &SartoriusCtrl_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, SartoriusCtrl)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::SartoriusCtrl_service_type_support_handle;
}
