...
static const _GetAbsRailPos_Request_type_support_symbol_names_t _GetAbsRailPos_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, GetAbsRailPos_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, GetAbsRailPos_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, GetAbsRailPos_Request)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::GetAbsRailPos_Request_message_type_support_handle;
}
...
static const _GetAbsRailPos_Response_type_support_symbol_names_t _GetAbsRailPos_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, GetAbsRailPos_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, GetAbsRailPos_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, GetAbsRailPos_Response)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::GetAbsRailPos_Response_message_type_support_handle;
}
...
static const _GetAbsRailPos_Event_type_support_symbol_names_t _GetAbsRailPos_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, GetAbsRailPos_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, GetAbsRailPos_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, GetAbsRailPos_Event)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::GetAbsRailPos_Event_message_type_support_handle;
}
...
static const _GetAbsRailPos_type_support_symbol_names_t _GetAbsRailPos_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_lab_custom_msg, srv, GetAbsRailPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_lab_custom_msg, srv, GetAbsRailPos)),
  }
};
...
static const rosidl_service_type_support_t GetAbsRailPos_service_type_support_handle = {
  ...
  &GetAbsRailPos_Request_message_type_support_handle,
  &GetAbsRailPos_Response_message_type_support_handle,
  &GetAbsRailPos_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, battery_lab_custom_msg, srv, GetAbsRailPos)() {
  return &::battery_lab_custom_msg::srv::rosidl_typesupport_c::GetAbsRailPos_service_type_support_handle;
}
