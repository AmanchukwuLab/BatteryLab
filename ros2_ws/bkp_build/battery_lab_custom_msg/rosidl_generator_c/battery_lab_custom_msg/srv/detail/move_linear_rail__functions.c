...
battery_lab_custom_msg__srv__MoveLinearRail_Request__create(void)
{
  ...
  battery_lab_custom_msg__srv__MoveLinearRail_Request * msg = (battery_lab_custom_msg__srv__MoveLinearRail_Request *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Request));
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Request__init(msg);
  if (!success) {
...
battery_lab_custom_msg__srv__MoveLinearRail_Request__destroy(battery_lab_custom_msg__srv__MoveLinearRail_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    battery_lab_custom_msg__srv__MoveLinearRail_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__init(battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Request * data = NULL;

  if (size) {
    data = (battery_lab_custom_msg__srv__MoveLinearRail_Request *)allocator.zero_allocate(size, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = battery_lab_custom_msg__srv__MoveLinearRail_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        battery_lab_custom_msg__srv__MoveLinearRail_Request__fini(&data[i - 1]);
      }
...
battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__fini(battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      battery_lab_custom_msg__srv__MoveLinearRail_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * array = (battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__init(array, size);
  if (!success) {
...
battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__destroy(battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__are_equal(const battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * lhs, const battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    battery_lab_custom_msg__srv__MoveLinearRail_Request * data =
      (battery_lab_custom_msg__srv__MoveLinearRail_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          battery_lab_custom_msg__srv__MoveLinearRail_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Response * msg = (battery_lab_custom_msg__srv__MoveLinearRail_Response *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Response));
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
battery_lab_custom_msg__srv__MoveLinearRail_Response__destroy(battery_lab_custom_msg__srv__MoveLinearRail_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    battery_lab_custom_msg__srv__MoveLinearRail_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__init(battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Response * data = NULL;

  if (size) {
    data = (battery_lab_custom_msg__srv__MoveLinearRail_Response *)allocator.zero_allocate(size, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = battery_lab_custom_msg__srv__MoveLinearRail_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        battery_lab_custom_msg__srv__MoveLinearRail_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__fini(battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      battery_lab_custom_msg__srv__MoveLinearRail_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * array = (battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__destroy(battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__are_equal(const battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * lhs, const battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    battery_lab_custom_msg__srv__MoveLinearRail_Response * data =
      (battery_lab_custom_msg__srv__MoveLinearRail_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          battery_lab_custom_msg__srv__MoveLinearRail_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__init(battery_lab_custom_msg__srv__MoveLinearRail_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(msg);
    return false;
  }
  // request
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__init(&msg->request, 0)) {
    battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(msg);
    return false;
  }
  // response
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__init(&msg->response, 0)) {
    battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(msg);
    return false;
  }
  return true;
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(battery_lab_custom_msg__srv__MoveLinearRail_Event * msg)
{
  ...
  // request
  battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__fini(&msg->request);
  // response
  battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__fini(&msg->response);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__are_equal(const battery_lab_custom_msg__srv__MoveLinearRail_Event * lhs, const battery_lab_custom_msg__srv__MoveLinearRail_Event * rhs)
{
  ...
  // request
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__are_equal(
  ...
  battery_lab_custom_msg__srv__MoveLinearRail_Event * output)
{
  ...
  // request
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!battery_lab_custom_msg__srv__MoveLinearRail_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Event * msg = (battery_lab_custom_msg__srv__MoveLinearRail_Event *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Event));
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__init(battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Event * data = NULL;

  if (size) {
    data = (battery_lab_custom_msg__srv__MoveLinearRail_Event *)allocator.zero_allocate(size, sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = battery_lab_custom_msg__srv__MoveLinearRail_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__fini(battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * array = (battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence *)allocator.allocate(sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__destroy(battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence__are_equal(const battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * lhs, const battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  battery_lab_custom_msg__srv__MoveLinearRail_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(battery_lab_custom_msg__srv__MoveLinearRail_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    battery_lab_custom_msg__srv__MoveLinearRail_Event * data =
      (battery_lab_custom_msg__srv__MoveLinearRail_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!battery_lab_custom_msg__srv__MoveLinearRail_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          battery_lab_custom_msg__srv__MoveLinearRail_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!battery_lab_custom_msg__srv__MoveLinearRail_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
